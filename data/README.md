...
To reproduce:
1) Obtain the dataset from the course-provided source / Kaggle.
2) Place it under data/raw/ (not tracked in git).
3) Run the notebook in notebooks/ to regenerate outputs.
